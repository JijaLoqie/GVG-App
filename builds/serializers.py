...
class BuildSerializer(serializers.ModelSerializer):
    images = ImageSerializer(source="BuildImage", required=False, many=True, read_only=True)

    class Meta:
        model = Build
        fields = ('id', 'title', 'description', 'price', 'old_price', 'status', 'body', 'ssd', 'motherboard', 'cpu', 'ram', 'hdd', 'graphics_card', 'power_supply', 'cpu_cooler', 'images')
